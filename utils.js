...
const utils = {
    ...
    restart: async function () {
        ...
        if (isYes(answer)) {
            ...
            execSync('ssh git@robocupnetwork.it "pm2 stop robocupnetwork"');
            execSync('ssh git@robocupnetwork.it "rm -rf /opt/apps/robocupnetwork/*"');
            execSync('ssh git@robocupnetwork.it "cp -r /opt/staging/robocupnetwork/* /opt/apps/robocupnetwork"');
            execSync('ssh git@robocupnetwork.it "pm2 start /opt/ecosystems/robocupnetwork.config.js --env production"');
